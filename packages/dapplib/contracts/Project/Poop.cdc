...
pub contract Poop: FungibleToken {
    ...
    init() {
        self.VaultStoragePath = /storage/poopVault
        self.ReceiverPublicPath = /public/poopReceiver
        self.BalancePublicPath = /public/poopBalance
        self.AdminStoragePath = /storage/poopAdmin
        self.MinterStoragePath = /storage/poopMinter
        self.MinterProxyPublicPath = /public/poopMinterProxy
        self.MinterProxyStoragePath = /storage/poopMinterProxy
