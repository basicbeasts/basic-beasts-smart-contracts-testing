...
export default class PackNFTHarness extends LitElement {
    ...
    render() {
      ...
      <!-- CHARACTERX -->
        ...
        <!-- CREATE SET (POST) -->
        <action-card title="Create a set" description="Create a set for characters. *Only admin."
          action="characterxCreateSet" method="post" fields="signer setName">
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="setName" label="Set Name" placeholder="Set Legendaries"></text-widget>
        </action-card>

        <!-- SETS GET SET NAME (GET) -->
        <action-card title="Get Set Name" description="Enter the Set ID to get the Set's name"
          action="characterxGetSetName" method="get" fields="setID">
          <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
        </action-card>

        <!-- CREATE CHARACTER (POST) -->
        <action-card title="Create a character" description="Enter the required fields to create a character. *Only admin. ?NOT SURE -> DAPP_RESULT_STRING"
          action="characterxCreateCharacter" method="post" fields="signer name description image createdFrom_1 createdFrom_2 sex race rarity lineage bloodline element traits data">
          <account-widget field="signer" label="Signer"></account-widget>
          ...
          <text-widget field="lineage" label="Lineage" placeholder="Lineage"></text-widget>
          <bool-widget field="lineage" label="Lineage" placeholder="Lineage"></bool-widget>
          <text-widget field="bloodline" label="Bloodline" placeholder="Bloodline"></text-widget>
          <text-widget field="element" label="Element" placeholder="Element"></text-widget>
          <text-widget field="traits" label="Traits" placeholder="Traits"></text-widget>
          <text-widget field="data" label="Data" placeholder="Data"></text-widget>
        </action-card>

        <!-- MINT CHARACTER (POST) -->
        <action-card title="Mint a character" description="Mint a character. *Only admin."
          action="characterxMintCharacter" method="post" fields="signer setID characterID recipientAddr">
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
        ...
        <action-card title="Add a character to a set" description="*Only admin"
          action="characterxAddCharacterToSet" method="post" fields="signer setID characterID">
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
          <text-widget field="characterID" label="Character ID" placeholder="0"></text-widget>
        </action-card>
        ...
        <action-card title="-Add a characters to a set" description="*Only admin"
          action="characterxAddCharactersToSet" method="post" fields="signer setID characterID">
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
          <text-widget field="characters" label="Character IDs separate with ," placeholder="?"></text-widget>
        </action-card>


        <!-- BATCH MINT CHARACTER (POST) -->
        <action-card title="-Batch mint a character" description="*Only admin"
          action="characterxBatchMintCharacter" method="post" fields="signer setID characterID quantity recipientAddr">
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
          <text-widget field="characterID" label="Character ID" placeholder="0"></text-widget>
        ...
        <!-- FULFILL PACK (POST) -->
        <action-card title="-Fulfill pack" description="*Only admin. Array input"
          action="" method="post" fields="recipientAddr characterID1 characterID2 characterID3">
          <account-widget field="recipientAddr" label="Recipient Address"></account-widget>
        ...
        <!-- LOCK SET (POST) -->
        <action-card title="Lock a set" description="*Only admin"
          action="characterxLockSet" method="post" fields="signer setID">
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
        </action-card>
        ...
        <action-card title="Retire a character from a set" description="*Only admin"
        action="characterxRetireCharacterFromSet" method="post" fields="signer setID">
        <account-widget field="signer" label="Signer"></account-widget>
        <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
        <text-widget field="characterID" label="Character ID" placeholder="0"></text-widget>
        </action-card>
        ...
        <action-card title="Start new series" description="*Only admin"
        action="characterxStartNewSeries" method="post" fields="signer">
        <account-widget field="signer" label="Signer"></account-widget>
        </action-card>

        <!-- TRANSFER ADMIN (POST) -->
        <action-card title="-Transfer admin" description="*Only admin"
        action="characterxTransferAdmin" method="post" fields="signer recipientAddr">
        <account-widget field="signer" label="Signer"></account-widget>
        <account-widget field="recipientAddr" label="Recipient Address"></account-widget>
        </action-card>
        ...
        <action-card title="Buy NFT without referral" description=""
        action="characterxBuyingNFTWithoutReferral" method="post" fields="amount to">
        <text-widget field="amount" label="Amount" placeholder="10.0"></text-widget>
        <account-widget field="to" label="Buyer"></account-widget>
        </action-card>

        <!-- GET CURRENT SERIES (GET) -->
        <action-card title="Get current series" description=""
        action="characterxGetCurrentSeries" method="get" fields="">
        </action-card>

        <!-- GET TOTAL SUPPLY (GET) -->
        <action-card title="Get current supply" description=""
        action="characterxGetTotalSupply" method="get" fields="">
        </action-card>

        <!-- CHARATERS GET ALL CHARACTERS (GET) -->
        <action-card title="Get all characters" description="Return with array."
        action="characterxCharactersGetAllCharacters" method="get" fields="">
        </action-card>
        
        <!-- CHARACTERS GET NEXT CHARACTER ID (GET) -->
        <action-card title="Get the next character ID" description=""
        action="characterxCharactersGetNextCharacterID" method="get" fields="">
        </action-card>
        ...
        <action-card title="Sets get next set ID" description=""
        action="characterxSetsGetNextSetID" method="get" fields="">
        </action-card>
        
        <!-- SETS GET NUM CHARACTERS IN EDITION (GET) -->
        <action-card title="Sets get num character in edition" description=""
        ...
        <action-card title="Sets get set series" description=""
        action="characterxSetsGetSetSeries" method="get" fields="setID">
        <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
        </action-card>

        <!-- SETS GET SET LOCKED (GET) -->
        <action-card title="Sets get set locked" description=""
        action="characterxSetsGetSetLocked" method="get" fields="setID">
        <text-widget field="setID" label="Set ID" placeholder="0"></text-widget>
        </action-card>
        ...
        <action-card title="Collections get data field" description=""
        ...
        <action-card title="Collections get character ID" description=""
        action="characterxCollectionsGetCharacterCharacterID" method="get" fields="account id">
        <account-widget field="account" label="Account"></account-widget>
        <text-widget field="id" label="ID" placeholder="0"></text-widget>
        </action-card>
        ...
        <action-card title="Collections get character series" description=""
        action="characterxCollectionsGetCharacterSeries" method="get" fields="account id">
        <account-widget field="account" label="Account"></account-widget>
        <text-widget field="id" label="ID" placeholder="0"></text-widget>
        </action-card>

        <!-- COLLECTIONS GET CHARACTER SET ID (GET) -->
        <action-card title="Collections get character set id" description=""
        action="characterxCollectionsGetCharacterSetID" method="get" fields="account id">
        <account-widget field="account" label="Account"></account-widget>
        <text-widget field="id" label="ID" placeholder="0"></text-widget>
        </action-card>
